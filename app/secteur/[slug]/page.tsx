...
const sectors: Record<string, SectorContent> = {
  restaurant: {
    ...
    h1: 'Plaque NFC pour restaurants : un avis Google en dix secondes, à table',
    ...
    problemTitle: 'Le problème : vos clients satisfaits repartent sans laisser d\'avis',
    problemPoints: [
      'Vos clients sont satisfaits après le repas, mais oublient de laisser un avis',
      'Demander de vive voix ne suffit pas : le client dit oui, puis passe à autre chose',
      'Un QR code oblige à ouvrir l\'appareil photo et à cadrer, souvent dans une salle peu éclairée',
      'Sans avis récents, votre fiche perd du terrain dans le pack local Google',
      'Vos concurrents bien notés captent les clients qui hésitaient entre vous et eux',
    ],
    ...
    solutionSteps: [
      ...
      { title: 'Les avis arrivent au fil du service', description: 'Chaque table devient une occasion. C\'est la régularité qui fait monter le volume, pas un coup d\'éclat sur une semaine.' },
    ],
    bestPlacements: [
      '🍽️ Sur la table — le client est assis, son téléphone est devant lui',
      '📋 Sur le porte-addition — il arrive dans ses mains au bon moment',
      '💳 À la caisse — quelques secondes d\'attente pendant le paiement',
      '🚪 À la sortie — en complément, le client est déjà debout',
    ],
    formats: {
  ...
  'salon-coiffure': {
    ...
    h1: 'Plaque NFC pour salons de coiffure : l\'avis se laisse au fauteuil',
    intro: 'Vos clientes restent une heure au fauteuil, repartent contentes, téléphone à portée de main. Il ne manque qu\'un support à approcher au bon moment.',
    heroStat: { value: '10 s', label: 'pour qu\'une cliente laisse son avis' },
    problemTitle: 'Le problème : vos clientes repartent ravies, et sans avis',
    problemPoints: [
      'Vos clientes sont ravies en sortant... mais oublient de laisser un avis',
      'Demander de vive voix oblige la cliente à retrouver votre fiche elle-même, une fois rentrée',
      'Un QR code impose d\'ouvrir l\'appareil photo, de viser, puis de valider une redirection',
      'Dans le pack local, la cliente compare votre note et votre nombre d\'avis à ceux des salons voisins',
    ...
    solutionSteps: [
      ...
      { title: 'La cliente approche son téléphone, le formulaire s\'ouvre', description: 'Une dizaine de secondes, sans application à installer, au moment où elle découvre sa coupe.' },
      { title: 'Vous suivez le résultat sur votre propre fiche', description: 'Comptez vos avis le jour de la pose, puis chaque mois : c\'est la seule mesure fiable, et elle est gratuite.' },
    ],
    bestPlacements: [
      '💇 Sur le miroir du poste de coiffage : dans le champ de vision toute la prestation',
      '🪞 Près du miroir d\'accueil : la cliente s\'y regarde une dernière fois avant de partir',
      '💳 À la caisse : le téléphone est déjà en main pour régler',
      '🎁 Dans le sac de revente produit : elle la retrouve chez elle, quelques jours plus tard',
    ],
    formats: {
  ...
  'cabinet-medical': {
    ...
    solutionSteps: [
      ...
      { title: 'Les patients satisfaits laissent un avis sans qu\'on le leur demande', description: 'Tout en restant conforme à votre code de déontologie professionnelle.' },
    ],
    bestPlacements: [
      '🏥 À l\'accueil, à côté du paiement : le patient a déjà son téléphone en main',
      '🪑 Dans la salle d\'attente, sur la table basse : visible sans être présentée',
      '📋 Sur le bureau, en fin de consultation : le moment où le patient est satisfait',
      '🚪 À la sortie, sur le mur ou présentoir discret : aucune sollicitation directe',
    ],
    formats: {
