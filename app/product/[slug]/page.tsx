...
const products = {
  ...
  'pro': {
    ...
    description: 'La solution complète avec 5 plaques NFC avis Google pour équiper tous vos emplacements. Idéal pour les entreprises multi-sites : tableau de bord analytics, liens personnalisables, support 24/7. Acrylique premium, garanti 3 ans.',
    ratingValue: 5.0,
    reviewCount: 156,
    guaranteeYears: 3,
    features: [
