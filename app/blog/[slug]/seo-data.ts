...
export const seoData: Record<string, ArticleSeo> = {
  'quand-clients-laissent-avis-google': {
    title: 'Quand les clients laissent-ils leurs avis Google ? Chiffres',
    description: 'Heures, jours et saisons : quand vos clients publient vraiment leurs avis Google. Délai réel entre le scan et la publication, tableaux par secteur et 7 erreurs de timing.',
    keywords: 'quand laisser un avis google, delai avis google, avis google combien de temps, heure publication avis google, saisonnalite avis google, frequence avis google, velocite avis google, fraicheur avis google, rythme avis google, meilleur moment demander un avis',
    date: '2026-09-07',
    dateModified: '2026-09-07',
    category: 'Statistiques',
    faq: [
      { q: 'Combien de temps un avis met-il à apparaître sur ma fiche Google ?', a: 'La plupart des avis sont visibles en quelques secondes à quelques minutes après leur validation. Un délai plus long, de quelques heures à deux ou trois jours, survient quand l\'avis passe par une vérification automatique : compte récent, avis très court, pic inhabituel sur la fiche, ou texte contenant un lien ou un numéro de téléphone. Si un client vous affirme avoir publié un avis que vous ne voyez pas après 72 heures, il est probable qu\'il ait été filtré ; demandez-lui de vérifier depuis son propre compte, dans la section « Vos contributions », où l\'avis reste visible pour lui même lorsqu\'il n\'est plus affiché publiquement.' },
      { q: 'Y a-t-il une heure idéale pour demander un avis ?', a: 'L\'heure de la journée compte beaucoup moins que la position dans le parcours client. Le bon moment est toujours le même : juste après la fin de la prestation, quand le résultat est constaté et que le téléphone est déjà en main pour payer. Une demande faite à 10 h après une coupe réussie fonctionne mieux qu\'une demande faite à 20 h pendant l\'attente. En revanche, l\'heure influence le délai de publication : un client servi en fin de journée publiera plus vite, parce que son moment de disponibilité arrive immédiatement après.' },
      { q: 'Faut-il éviter de collecter trop d\'avis d\'un coup ?', a: 'Il faut éviter les anomalies, pas le volume. Une fiche qui reçoit habituellement deux avis par mois et qui en enregistre quarante en trois jours présente un profil atypique qui peut déclencher une vérification, voire une mise en pause temporaire des nouveaux avis. En revanche, une montée progressive proportionnelle à votre fréquentation ne pose aucun problème : un commerce qui sert 400 clients mensuels peut parfaitement en collecter 40 sans que cela paraisse anormal. La règle sûre est de viser un rythme régulier plutôt qu\'une opération coup de poing.' },
      { q: 'Un avis ancien perd-il de la valeur ?', a: 'Il conserve sa valeur dans le calcul de la note moyenne et dans le total affiché, mais il perd sa valeur d\'influence. D\'une part, Google met en avant les avis récents dans l\'aperçu de la fiche, donc un avis de 2020 n\'est presque jamais lu. D\'autre part, un internaute qui voit que le dernier avis date d\'un an en tire une conclusion sur l\'activité de l\'établissement. Concrètement : les anciens avis vous font exister, les récents vous font choisir.' },
      { q: 'Comment maintenir la collecte pendant la basse saison ?', a: 'En cessant de raisonner en volume et en raisonnant en taux. Si vous servez trois fois moins de clients, obtenir trois fois moins d\'avis est un fonctionnement normal, pas un échec. Le seul réglage utile en creux est de relever la conversion : comme le personnel est moins sous pression, c\'est la période où la demande orale peut être faite à chaque client, ce qui compense une partie de la baisse de flux. C\'est aussi le bon moment pour traiter les chantiers de fiche qui ne dépendent pas du passage — photos, réponses en retard, attributs.' },
      { q: 'Le jour de fermeture influence-t-il ma fiche ?', a: 'Pas directement. Ce qui compte pour Google, c\'est que vos horaires déclarés soient exacts, y compris les jours fériés, car une fiche qui envoie des clients devant une porte close génère des avis négatifs faciles à éviter. L\'absence d\'avis un jour de fermeture n\'est en revanche pas un signal négatif : les publications se répartissent naturellement, et une partie des avis d\'un samedi apparaîtra le dimanche, jour où beaucoup de commerces sont fermés.' },
      { q: 'Combien de temps faut-il pour voir un effet sur mon classement local ?', a: 'Comptez trois à six mois pour un effet lisible, et davantage si l\'écart avec les trois fiches du pack local est important. Le classement ne réagit pas à un avis mais à une tendance : il faut que le volume, la fraîcheur et la note bougent ensemble sur plusieurs mois. Un dispositif installé en janvier montre généralement ses premiers effets de position au printemps, à condition que le rythme n\'ait pas été interrompu.' },
    ],
  },
  'combien-de-plaques-nfc': {
    title: 'Combien de plaques NFC pour votre commerce ? 1, 2 ou 5',
    description: 'Combien de plaques NFC faut-il pour collecter des avis Google ? Méthode de calcul, tableau par secteur, coût par avis selon le pack et 6 erreurs à éviter.',
    keywords: 'combien de plaques nfc, nombre de plaques nfc avis google, pack plaque nfc, plaque nfc combien, plusieurs plaques nfc, plaque nfc multi etablissement, equiper commerce plaque nfc, plaque avis google nombre, pack business plaque nfc, plaque nfc plusieurs points de vente',
    date: '2026-09-04',
    dateModified: '2026-09-04',
    category: 'Comparatif',
    faq: [
      { q: 'Une seule plaque NFC suffit-elle pour un commerce ?', a: 'Oui, si votre parcours client est linéaire et se termine à un seul endroit : petite boutique, kiosque, atelier de retouche, artisan itinérant. Dans ces cas, le point d\'encaissement concentre la totalité des occasions de demande et un second support n\'ajouterait rien. En revanche, dès qu\'il existe un poste de prestation distinct de la caisse — un fauteuil, un bureau, une table — vous laissez entre 30 et 60 % du gisement inexploité avec une seule plaque. La règle pratique : comptez les endroits où un client s\'arrête après la fin de la prestation, et non le nombre de pièces.' },
      { q: 'Deux plaques collectent-elles deux fois plus d\'avis ?', a: 'Non, et il faut s\'en méfier. Les deux emplacements captent des populations qui se recouvrent partiellement : un client qui a scanné au fauteuil ne rescannera pas en caisse. Le gain réel observé se situe entre 30 et 60 % de volume supplémentaire, ce qui reste excellent rapporté au coût. Un doublement n\'est possible que si les deux plaques touchent des flux réellement distincts, par exemple deux comptoirs séparés d\'un garage ou deux points de vente différents.' },
      { q: 'Peut-on programmer chaque plaque avec un lien d\'avis différent ?', a: 'Oui, et c\'est indispensable si vous gérez plusieurs établissements. Chaque adresse possède sa propre fiche Google Business Profile, donc son propre lien d\'avis : il suffit de préciser les liens souhaités à la commande. Une erreur fréquente consiste à équiper trois boutiques avec le même lien — tous les avis se concentrent alors sur une seule fiche, et les deux autres restent invisibles dans le pack local de leur quartier. Google ne permet pas de déplacer un avis d\'un établissement vers un autre après coup.' },
      { q: 'Faut-il une plaque par salarié ou par poste de travail ?', a: 'Par poste, jamais par salarié. Ce qui compte est le point physique où le client se trouve à la fin de la prestation, pas la personne qui l\'a servi. Trois coiffeurs qui se partagent deux fauteuils actifs n\'ont besoin que de deux plaques plus celle de la caisse. À l\'inverse, un cabinet où deux praticiens exercent simultanément dans deux bureaux distincts a bien besoin de deux plaques, plus une à l\'accueil, car les patients ne repassent pas tous par le même point de sortie.' },
      { q: 'Que faire si j\'ai acheté trop de plaques ?', a: 'Rien n\'est perdu, mais évitez de toutes les poser dans le même local : au-delà de deux ou trois supports visibles, l\'effet de saturation visuelle réduit l\'attention portée à chacune. Les meilleures utilisations d\'un surplus sont la plaque de rechange en réserve, la plaque confiée à un commercial ou un technicien itinérant, et la plaque destinée à un futur second point de vente. Une plaque non posée conserve toute sa valeur : la puce ne se dégrade pas au stockage et la garantie reste acquise.' },
      { q: 'Le pack de 5 est-il rentable pour un commerce unique ?', a: 'Il l\'est dans un cas précis : quand l\'établissement compte plusieurs postes de prestation fonctionnant en parallèle, comme un salon à quatre fauteuils ou un institut à trois cabines. En dehors de cette configuration, le pack de deux couvre l\'essentiel et le surplus dort. Cela dit, le coût unitaire chute nettement — environ 18 € la plaque contre 29,90 € à l\'unité — donc garder deux unités d\'avance reste économiquement défendable si vous anticipez un réagencement ou une ouverture.' },
      { q: 'Combien de plaques faut-il pour entrer dans le pack local Google ?', a: 'Aucun nombre de plaques ne garantit une position : le pack local se joue sur la pertinence, la distance et la proéminence, et seule la troisième dépend de vos avis. La bonne façon de poser la question est inverse — combien d\'avis vous manque-t-il par rapport aux trois fiches actuellement affichées, en combien de mois voulez-vous les obtenir, et votre flux client permet-il ce rythme. Un dispositif à deux plaques accompagné d\'une demande orale systématique produit typiquement 10 à 40 avis mensuels selon le secteur, ce qui suffit à combler la plupart des écarts en six à douze mois.' },
    ],
  },
  'plaque-nfc-artisan-plombier': {
    title: 'Plaque NFC plombier et artisan : avis Google sans boutique',
    description: 'Plombier, électricien, chauffagiste : collecter des avis Google sans comptoir. 6 emplacements, fiche en zone de service, 3 scripts et exemples chiffrés.',
    keywords: 'plaque nfc plombier, plaque nfc artisan, avis google artisan, avis google plombier, avis google electricien, fiche google artisan sans adresse, zone de service google business profile, avis google batiment, plaque nfc chauffagiste, collecter avis google artisan',
    date: '2026-09-02',
    dateModified: '2026-09-02',
    category: 'Secteur',
    faq: [
      { q: 'Une plaque NFC a-t-elle un intérêt quand on n\'a pas de boutique ?', a: 'Oui, et c\'est même le cas où l\'écart avec les autres méthodes est le plus grand. L\'artisan n\'a pas de comptoir, donc pas de moment de caisse : sa seule fenêtre est la fin d\'intervention, chez le client, et elle dure une minute. Une plaque fixée sur la pochette de devis ou sur la mallette recrée ce comptoir et le rend transportable. Toutes les alternatives — carte de visite, SMS, lien dans le mail de facture — reportent l\'action à plus tard, et ce qui est reporté n\'est pas fait.' },
      { q: 'Où fixer la plaque quand on travaille chez le client ?', a: 'Sur la pochette de devis ou le porte-documents en priorité : c\'est l\'objet que vous sortez au moment de la signature ou de la remise de facture, donc au moment exact où la demande est légitime. La mallette à outils, côté couvercle et sur une zone non métallique, constitue un excellent second emplacement puisqu\'elle reste visible pendant toute l\'intervention. Le véhicule et l\'atelier n\'arrivent qu\'ensuite, et le floquage extérieur ne collecte rien du tout.' },
      { q: 'Combien d\'avis Google un plombier peut-il espérer par mois ?', a: 'Cela dépend de deux nombres que vous connaissez : vos interventions terminées et la fréquence à laquelle la phrase est réellement dite. Un plombier seul à soixante interventions mensuelles qui demande une fois sur deux se situe autour de sept à neuf avis par mois. La même activité avec une demande systématique dépasse quinze. Un chauffagiste à quatorze gros chantiers obtient trois à quatre avis, soit une quarantaine par an, ce qui suffit largement dans un secteur où la concurrence locale plafonne souvent sous les vingt avis.' },
      { q: 'La plaque fonctionne-t-elle si je la colle sur ma caisse à outils en métal ?', a: 'Mal, et parfois pas du tout. Le métal génère des courants de Foucault qui absorbent le champ magnétique et désaccordent l\'antenne de la puce : la lecture devient aléatoire selon l\'angle du téléphone. C\'est la première cause de plaque jugée défectueuse. Choisissez une zone en plastique, un couvercle de mallette composite, ou intercalez un support non métallique entre la plaque et la surface.' },
      { q: 'Peut-on demander un avis alors que la facture n\'est pas encore payée ?', a: 'Oui, et c\'est même souvent préférable. L\'avis porte sur la prestation, pas sur le règlement, et le moment où le client constate le résultat est nettement plus favorable que le jour où il reçoit la facture. Attendre le paiement, dans un métier où le virement arrive parfois trois semaines plus tard, revient à laisser passer la seule fenêtre exploitable.' },
      { q: 'Un artisan sans adresse visible peut-il avoir une fiche Google ?', a: 'Oui, via une fiche en zone de service : vous saisissez votre adresse pour la vérification puis vous la masquez, et vous déclarez les communes où vous intervenez. Attention toutefois à une illusion fréquente : déclarer trente communes n\'étale pas votre visibilité sur trente communes, car Google continue de classer sur la distance réelle à votre point de rattachement. Cela indique seulement votre périmètre d\'intervention. Le levier qui reste sous votre contrôle est la proéminence, c\'est-à-dire le volume, la fraîcheur et la note de vos avis.' },
      { q: 'Faut-il un abonnement pour utiliser une plaque NFC ?', a: 'Non. La plaque Swiipx est un achat unique, expédiée déjà programmée avec votre lien d\'avis Google : aucune application à installer, aucun code d\'activation, aucun frais mensuel. Elle continue de fonctionner des années après l\'achat, et la puce est garantie à vie. C\'est la différence de fond avec les offres à abonnement, où l\'arrêt du prélèvement désactive le support que vous avez pourtant payé.' },
    ],
  },
