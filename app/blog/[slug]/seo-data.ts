...
export const seoData: Record<string, ArticleSeo> = {
  ...
  'magnet-nfc-avis-google': {
    ...
    faq: [
      ...
      { q: 'Faut-il un abonnement pour un magnet ou une plaque NFC ?', a: 'Aucun des deux ne l\'exige techniquement. La puce contient une adresse web, celle de votre page d\'avis Google, qui ne change pratiquement jamais une fois l\'établissement créé. Certains vendeurs facturent un abonnement mensuel pour un lien reprogrammable et un tableau de bord. Les plaques Swiipx sont vendues en paiement unique, à partir de 35,88 € TTC pour une plaque, avec garantie à vie et livraison en point relais offerte.' },
    ],
  },
  'cout-avis-google-comparatif': {
    ...
    faq: [
      ...
      { q: "Quel est le coût par avis d'une plaque NFC ?", a: "Environ 0,06 € par avis sur 36 mois pour le matériel seul, et 0,12 € en incluant les 4 à 6 secondes de temps salarié par client. Le calcul repose sur un achat unique de 35,88 € à 107,88 € selon le pack, sans aucun frais récurrent, et sur une hypothèse de collecte que nous ne mesurons pas : refaites-le avec le taux que vous constatez sur votre fiche." },
  ...
  'prix-plaque-nfc-avis-google': {
    ...
    faq: [
      ...
      { q: 'Quelle économie sur un pack multi-plaques ?', a: 'Économie d\'échelle : le pack de 2 revient à 32,94 € la plaque, soit environ 8 % de moins que le prix unitaire ; le pack de 5 revient à 21,58 € la plaque, soit environ 40 % de moins. Ex. Swiipx : 1 plaque 35,88 €, 2 plaques 65,88 € (économie 5,88 €), 5 plaques 107,88 € (économie 71,52 €).' },
