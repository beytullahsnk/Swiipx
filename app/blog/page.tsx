...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: "Salles de sport, box de CrossFit, studios de pilates : collectez des avis Google avec une plaque NFC. Emplacements, moments clés, scripts coach, 3 exemples de calcul et ROI chiffré.",
    category: 'Secteur',
    date: '3 août 2026',
    dateIso: '2026-08-03',
    readTime: '11 min',
  ...
  {
    id: 20,
    title: 'Plaque NFC boulangerie : le placement qui tient malgré le rush',
    excerpt: 'Boulangeries, pâtisseries et points chauds : collectez des avis Google avec une plaque NFC malgré le rush. Emplacements, scripts vendeur, 3 exemples de calcul et ROI chiffré.',
    category: 'Secteur',
  ...
  {
    id: 18,
    title: 'Plaque NFC institut de beauté : quand la présenter après le soin',
    excerpt: 'Instituts de beauté, esthétique, onglerie, spa : collectez des avis Google avec une plaque NFC. Emplacements, scripts esthéticienne, 3 exemples de calcul et ROI chiffré.',
    category: 'Secteur',
  ...
  {
    id: 10,
    title: 'Plaque NFC salon de coiffure : placement et script en caisse',
    excerpt: 'Où poser la plaque dans un salon et quoi dire à l\'encaissement. Placements, scripts coiffeur, 3 exemples de calcul.',
    category: 'Secteur',
    date: '11 mai 2026',
    dateIso: '2026-05-11',
    readTime: '9 min',
